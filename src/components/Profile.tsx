...
export function Profile() {
  ...
  const handleAddPlot = () => {
    ...
    const plot = {
      ...
      riceVariety: newPlot.riceVariety,
      sowingDate: newPlot.sowingDate,
      harvestDate: newPlot.harvestDate,
      irrigation: newPlot.irrigation,
      area: parseFloat(newPlot.area) || 0,
      areaUnit: newPlot.areaUnit,
      photos: []
    };
    ...
    const updatedUser = {
      ...
      farms: user!.farms.map(farm => 
        farm.id === newPlot.farmId 
          ? { ...farm, plots: [...farm.plots, plot] }
          : farm
      )
    };
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                  <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex space-x-3">
                        <Button onClick={handleAddPlot} className="flex-1">
                          {t.addPlot}
                        </Button>
